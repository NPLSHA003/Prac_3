...
class ES2EEPROM:
    ...
    def write_block(self, start_block, data, bs=16, sleep_time=0.01):
        """
        ...
        for i, block in enumerate(blocks):
            ...
            data = [lb]+block
            write = i2c_msg.write((self.address + hb), data)
    ...
    def read_block(self, start_block, count, bs=16):
        ...
        for i in range(full_reads):
            ...
            read = i2c_msg.read((self.address + hb), count)
    ...
    def read_byte(self, reg):
        ...
        write = i2c_msg.write((self.address + hb), [lb])
        read = i2c_msg.read((self.address + hb), 1)
        self.bus.i2c_rdwr(write, read)  # combined read&write
        return list(read)[0]
    ...
    def populate_mock_scores(self):
        ...
        for i, score in enumerate(scores):
            ...
            self.write_block(i+1, data_to_write)
